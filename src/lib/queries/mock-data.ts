...
export const mockHouseTypes: HouseType[] = [
  {
    ...
    description:
      "Geräumiges Ferienhaus für Familien mit bis zu 6 Personen. Zwei Schlafzimmer, Wohnküche, Bad mit Dusche.",
    max_guests: 6,
    price_per_house: 850,
    price_per_person: null,
    total_quantity: 4,
    features: ["2 Schlafzimmer", "Wohnküche", "Bad mit Dusche", "Terrasse", "WLAN"],
    image_url: null,
    sort_order: 1,
    created_at: new Date().toISOString(),
  },
  {
    ...
    description:
      "Gemütliches Ferienhaus für kleine Familien mit bis zu 4 Personen. Ein Schlafzimmer, Wohnküche, Bad.",
    max_guests: 4,
    price_per_house: 650,
    price_per_person: null,
    total_quantity: 6,
    features: ["1 Schlafzimmer", "Wohnküche", "Bad mit Dusche", "WLAN"],
    image_url: null,
    sort_order: 2,
    created_at: new Date().toISOString(),
  },
  {
    ...
    slug: "einzelzimmer",
    description:
      "Komfortables Einzelzimmer im Haupthaus. Ideal für Einzelpersonen oder Paare.",
    max_guests: 2,
    price_per_house: 350,
    price_per_person: null,
    total_quantity: 8,
...
export const mockDocuments: Document[] = [
  ...
  },
  {
    ...
    event_id: MOCK_EVENT_ID,
    title: "Hausordnung",
    description: "Regeln und Hinweise für den Aufenthalt im Feriendorf.",
  ...
  },
  {
    ...
    description: "Vorläufiges Programm der Gemeindefreizeit 2026.",
